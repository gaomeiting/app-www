 ...
 * @Last Modified time: 2018-10-29 16:06:18
 */
<template>
<div  id="app" class="app">
  <div class="nav-bar-wrap">
			<nav-bar :showRightNav="showRightNav" @showAlertBox="showAlertBox" :computedPrice="computedPrice" :currentIndex="0"></nav-bar>
	</div>
  <transition name="fadePage" mode="out-in">
    <service-view @hideRightNav="hideRightNav" @showCodeBox="showAlertBox" @goComputedPrice="goComputedPrice"></service-view>
  </transition>
...
import ServiceView from 'views/service/service-view';
